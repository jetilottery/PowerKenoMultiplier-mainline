define([
    ...
    var scaleType;
    var continueButton, warningExitButton, errorExitButton, winBoxErrorExitButton;
    ...
    function onGameParametersUpdated() {
        ...
        winBoxErrorExitButton = new gladButton(gr.lib._winBoxExitButton, config.gladButtonImgName.errorExitButton, scaleType);
        ...
        if (config.style.winBoxExitText) {
            gameUtils.setTextStyle(gr.lib._winBoxExitText, config.style.winBoxExitText);
        }
        if (config.textAutoFit.winBoxExitText) {
            gr.lib._winBoxExitText.autoFontFitText = config.textAutoFit.winBoxExitText.isAutoFit;
        }
        ...
        winBoxErrorExitButton.click(function() {
            msgBus.publish('jLotteryGame.playerWantsToExit');
            if (config.audio && config.audio.ButtonGeneric) {
                audio.play(config.audio.ButtonGeneric.name, config.audio.ButtonGeneric.channel);
            }
