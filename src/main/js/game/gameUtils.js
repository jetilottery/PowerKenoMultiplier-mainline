    ...
    function fixMeter(gr) {//suggested font size is 20, _meterDivision0 and _meterDivision1 use font size 28
        ...
        if (balanceText.pixiContainer.visible) {
            if (SKBeInstant.getGameOrientation() === 'portrait') {
                var left0 = (nspliceWidth - balanceText._currentStyle._width) / 2;
                balanceText.updateCurrentStyle({'_left': left0, '_top': top4TwoLine1});
                var left1 = (nspliceWidth - balanceValue._currentStyle._width) / 2;
                balanceValue.updateCurrentStyle({'_left': left1, '_top': top4TwoLine0});
                meterDivision0.updateCurrentStyle({'_left': nspliceWidth - meterDivision0._currentStyle._width/2, '_top': (top4OneLine - 4)});
            } else {
                ...
                if (temp >= 6) {
                    ...
                    var left0 = (nspliceWidth - balanceText.pixiContainer.$text.width) / 2;
                    balanceText.updateCurrentStyle({'_left': left0, '_top': top4TwoLine1});
                    var left1 = (nspliceWidth - balanceValue.pixiContainer.$text.width) / 2;
                    balanceValue.updateCurrentStyle({'_left': left1, '_top': top4TwoLine0});
                }
                meterDivision0.updateCurrentStyle({'_left': nspliceWidth - 1, '_top': (top4OneLine - 4)});
            }

            if (SKBeInstant.getGameOrientation() === 'portrait') {
                var left0 = (nspliceWidth - ticketCostMeterText._currentStyle._width) / 2;
                ticketCostMeterText.updateCurrentStyle({'_left': nspliceWidth + left0, '_top': top4TwoLine1});
                var left1 = (nspliceWidth - ticketCostMeterValue._currentStyle._width) / 2;
                ticketCostMeterValue.updateCurrentStyle({'_left': nspliceWidth + left1, '_top': top4TwoLine0});
                meterDivision1.updateCurrentStyle({'_left': nspliceWidth * 2 - meterDivision1._currentStyle._width/2, '_top': (top4OneLine - 4)});
            } else {
                ...
                if (temp >= 6) {
                    ...
                    var left0 = (nspliceWidth - ticketCostMeterText.pixiContainer.$text.width) / 2;
                    ticketCostMeterText.updateCurrentStyle({'_left': nspliceWidth + left0, '_top': top4TwoLine1});
                    var left1 = (nspliceWidth - ticketCostMeterValue.pixiContainer.$text.width) / 2;
                    ticketCostMeterValue.updateCurrentStyle({'_left': nspliceWidth + left1, '_top': top4TwoLine0});
                }
                meterDivision1.updateCurrentStyle({'_left': nspliceWidth * 2 - 1, '_top': (top4OneLine - 4)});
            }

            if (SKBeInstant.getGameOrientation() === 'portrait') {
                var left0 = (nspliceWidth - winsText._currentStyle._width) / 2;
                winsText.updateCurrentStyle({'_left': nspliceWidth * 2 + left0, '_top': top4TwoLine1});
                var left1 = (nspliceWidth - winsValue._currentStyle._width) / 2;
                ...
                if (temp >= 6) {
                    ...
                    var left0 = (nspliceWidth - winsText.pixiContainer.$text.width) / 2;
                    winsText.updateCurrentStyle({'_left': nspliceWidth * 2 + left0, '_top': top4TwoLine1});
                    var left1 = (nspliceWidth - winsValue.pixiContainer.$text.width) / 2;
                    winsValue.updateCurrentStyle({'_left': nspliceWidth * 2 + left1, '_top': top4TwoLine0});
                }
            }
